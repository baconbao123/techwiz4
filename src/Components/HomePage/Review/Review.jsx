...
function Review() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setActiveTab((prevTab) => (prevTab + 1) % 8); // Assuming there are 8 tabs
    }, 4000);
  ...
  useEffect(() => {
    ...
    testimoniaPersonalItems[activeTab].classList.add("active");
    testimonialBodyItems[activeTab].classList.add("active");
  }, [activeTab]);

  return (
    <div>
      <div class="fui-testimonial-1">
        <div class="testimonialWrap">
          <ul class="testimonialBodyList" style={{listStyle:'none'}}>
            <li class="testimonialBodyItem active" data-tab="0">
              <div class="testimonialRate">
                <span>3.0</span>
                <div class="testimonialRateIconList">
                  <svg
                    width="23"
                    height="22"
                    viewBox="0 0 23 22"
              ...
              <div class="testimonialBodyPersonal">
                <div class="testimonialBodyPersonalImg">
                  <img
                ...
                <h4 class="testimonialBodyPersonalName">Mathieu Johet</h4>
              </div>
            </li>
            <li class="testimonialBodyItem" data-tab="1">
              <div class="testimonialRate">
                <span>4.0</span>
                <div class="testimonialRateIconList">
                  <svg
              ...
              <div class="testimonialBodyPersonal">
                ...
                <h4 class="testimonialBodyPersonalName">James</h4>
              </div>
            </li>
            <li class="testimonialBodyItem" data-tab="2">
              <div class="testimonialRate">
                <span>5.0</span>
                <div class="testimonialRateIconList">
                  <svg
              ...
              <div class="testimonialBodyPersonal">
                ...
                <h4 class="testimonialBodyPersonalName">Robert</h4>
              </div>
            </li>
            <li class="testimonialBodyItem" data-tab="3">
              <div class="testimonialRate">
                <span>4.0</span>
                <div class="testimonialRateIconList">
                  <svg
              ...
              <div class="testimonialBodyPersonal">
                ...
                <h4 class="testimonialBodyPersonalName">John</h4>
              </div>
            </li>
            <li class="testimonialBodyItem" data-tab="4">
              <div class="testimonialRate">
                <span>5.0</span>
                <div class="testimonialRateIconList">
                  <svg
              ...
              <div class="testimonialBodyPersonal">
                ...
                <h4 class="testimonialBodyPersonalName">Michael</h4>
              </div>
            </li>
            <li class="testimonialBodyItem" data-tab="5">
              <div class="testimonialRate">
                <span>3.0</span>
                <div class="testimonialRateIconList">
                  <svg
              ...
              <div class="testimonialBodyPersonal">
                ...
                <h4 class="testimonialBodyPersonalName">David</h4>
              </div>
            </li>
            <li class="testimonialBodyItem" data-tab="6">
              <div class="testimonialRate">
                <span>5.0</span>
                <div class="testimonialRateIconList">
                  <svg
              ...
              <div class="testimonialBodyPersonal">
                ...
                <h4 class="testimonialBodyPersonalName">William</h4>
              </div>
            </li>
            <li class="testimonialBodyItem" data-tab="7">
              <div class="testimonialRate">
                <span>5.0</span>
                <div class="testimonialRateIconList">
                  <svg
              ...
              <div class="testimonialBodyPersonal">
                ...
                <h4 class="testimonialBodyPersonalName">Richard</h4>
              </div>
            </li>
          </ul>
          <ul class="testimoniaPersonalList" style={{listStyle:'none'}}>
            <li class="testimoniaPersonalItem active" data-tab="0">
              <div class="testimoniaPersonalImage">
                <img
                  src="https://images.unsplash.com/photo-1440589473619-3cde28941638?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=387&amp;q=80"
                  alt="Mathieu Johet"
                />
            ...
            <li class="testimoniaPersonalItem" data-tab="1">
              <div class="testimoniaPersonalImage">
                <img
                  src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=387&amp;q=80"
                  alt="James"
            ...
            <li class="testimoniaPersonalItem" data-tab="2">
              <div class="testimoniaPersonalImage">
                <img
                  src="https://images.unsplash.com/photo-1522529599102-193c0d76b5b6?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1170&amp;q=80"
                  alt="Robert"
            ...
            <li class="testimoniaPersonalItem" data-tab="3">
              <div class="testimoniaPersonalImage">
                <img
                  src="https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=387&amp;q=80"
                  alt="John"
            ...
            <li class="testimoniaPersonalItem" data-tab="4">
              <div class="testimoniaPersonalImage">
                <img
                  src="https://images.unsplash.com/photo-1481824429379-07aa5e5b0739?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=396&amp;q=80"
                  alt="Michael"
            ...
            <li class="testimoniaPersonalItem" data-tab="5">
              <div class="testimoniaPersonalImage">
                <img
                  src="https://images.unsplash.com/photo-1517256673644-36ad11246d21?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=387&amp;q=80"
                  alt="David"
            ...
            <li class="testimoniaPersonalItem" data-tab="6">
              <div class="testimoniaPersonalImage">
                <img
                  src="https://images.unsplash.com/photo-1534614971-6be99a7a3ffd?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=387&amp;q=80"
                  alt="William"
            ...
            <li class="testimoniaPersonalItem" data-tab="7">
              <div class="testimoniaPersonalImage">
                <img
                  src="https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?ixlib=rb-4.0.3&amp;ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&amp;auto=format&amp;fit=crop&amp;w=1171&amp;q=80"
                  alt="Richard"
