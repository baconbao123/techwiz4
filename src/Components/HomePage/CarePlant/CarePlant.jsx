        ...
        <Row>
            <Col lg={6}>
                ...
                <div className='mt-3'>
                    ...
                    <div className='ms-5'>When caring for indoor plants, make sure the room temperature is neither too cold nor too hot</div>
                </div>
                <div className='mt-3'>
                    <img src={water} />
                    <span className='fw-medium fs-5 ms-3'>Don't water too often</span>
                    <div className='ms-5'>Watering ornamental plants indoors does not have to be done every day</div>
                </div>
                <div className='mt-3'>
                    <img src={ferte} />
                    <span className='fw-medium fs-5 ms-3'>Fertilize regularly</span>
                    <div className='ms-5'>The nutrients most indoor houseplants need are nitrogen for balance and potassium for stem strength</div>
                </div>
            </Col>
            ...
            <Col lg={6} className='mt-5'>
                ...
                <div className='button-plants button-item'>
                            Plants
                </div>
                <div className='button-tool button-item'>
                            Tools
                </div>
